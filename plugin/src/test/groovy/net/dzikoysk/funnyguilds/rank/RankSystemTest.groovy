...
class RankSystemTest extends FunnyGuildsSpec {
    ...
    void 'ELO rank system test 1000 vs 1000'() {
        ...
        def result = rankSystem.calculate(RankSystem.RankType.ELO, 1000, 1000)
    ...
    void 'ELO rank system test 1100 vs 1000'() {
        def rankSystem = RankSystem.create()
        def result = rankSystem.calculate(RankSystem.RankType.ELO, 1100, 1000)
    ...
    void 'ELO rank system test 1000 vs 1200'() {
        def rankSystem = RankSystem.create()
        def result = rankSystem.calculate(RankSystem.RankType.ELO, 1000, 1200)
    ...
    void 'ELO rank system test 1200 vs 800'() {
        def rankSystem = RankSystem.create()
        def result = rankSystem.calculate(RankSystem.RankType.ELO, 1200, 800)
    ...
    void 'PERCENT rank system test'() {
        def rankSystem = RankSystem.create()
        def result = rankSystem.calculate(RankSystem.RankType.PERCENT, 1000, 1000)

        assertEquals 10, result.attackerPoints
        assertEquals 10, result.victimPoints

        result = rankSystem.calculate(RankSystem.RankType.PERCENT, 1000, 1200)
    ...
    void 'STATIC rank system test'() {
        def rankSystem = RankSystem.create()
        def result = rankSystem.calculate(RankSystem.RankType.STATIC, 1000, 1000)
