...
public class IndividualNameTagManager extends AbstractScoreboardHandler<IndividualNameTag> {
    ...
    protected void update(
        AbstractScoreboardHandler<IndividualNameTag>.UpdateData observerData,
        AbstractScoreboardHandler<IndividualNameTag>.UpdateData targetData
    ) {
