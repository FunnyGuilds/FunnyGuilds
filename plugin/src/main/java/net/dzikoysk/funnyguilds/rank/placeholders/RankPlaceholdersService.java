...
public class RankPlaceholdersService implements PlaceholdersService<User> {
    ...
    public Component formatTop(
        ...
        //
        //        Option<Integer> indexOption = Option.attempt(NumberFormatException.class, () -> Integer.parseInt
        //        (indexString));
     ...
     * @return formatted text
     */
    public Component formatTopPosition(
            Component text,
            @Nullable User targetUser
    ) {
        throw new UnsupportedOperationException("Reimplement");
        ...
        //            String minMembersToIncludeNoValue = this.messageService.get(targetUser, config -> config
        //            .minMembersToIncludeNoValue);
        //            if (targetUser == null) {
    ...
    // TODO Migrate all {PTOP/GTOP-x} placeholders to new {PTOP/GTOP-type-x} and remove this metho
