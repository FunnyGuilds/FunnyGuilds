...
public class MessageConfiguration extends OkaeriConfig {
    ...
    public String rankLastAttackerV = "&7Ostatnio zostales zabity przez tego samego gracza, punkty nie zostaja dodane!";
    public String rankLastAttackerA = "&7Ostatnio zabiles tego samego gracza, punkty nie zostaja odebrane!";
