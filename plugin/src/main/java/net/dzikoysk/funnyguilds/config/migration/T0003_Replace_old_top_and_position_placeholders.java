...
public class T0003_Replace_old_top_and_position_placeholders extends NamedMigration {
    ...
    public T0003_Replace_old_top_and_position_placeholders() {
        super(
    ...
    private static SendableMessage replaceLegacyPlaceholders(SendableMessage message) {
