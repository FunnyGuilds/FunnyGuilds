    ...
    public List<TablistPage> pages = new LinkedList<>(
            Arrays.asList(
                    ...
                    new TablistPage(10, ImmutableMap.<Integer, String>builder()
                            ...
                            .put(46, " &e1. &7{PTOP-KILLS-1}")
                            .put(47, " &e2. &7{PTOP-KILLS-2}")
                            .put(48, " &e3. &7{PTOP-KILLS-3}")
                            .put(49, " &e4. &7{PTOP-KILLS-4}")
                            .put(50, " &e5. &7{PTOP-KILLS-5}")
                            .put(51, " &e6. &7{PTOP-KILLS-6}")
                            .put(52, " &e7. &7{PTOP-KILLS-7}")
                            .put(53, " &e8. &7{PTOP-KILLS-8}")
                            .put(54, " &e9. &7{PTOP-KILLS-9}")
                            .put(55, " &e10. &7{PTOP-KILLS-10}")
                    ...
                    new TablistPage(10, ImmutableMap.<Integer, String>builder()
                            ...
                            .put(46, " &c1. &7{PTOP-DEATHS-1}")
                            .put(47, " &c2. &7{PTOP-DEATHS-2}")
                            .put(48, " &c3. &7{PTOP-DEATHS-3}")
                            .put(49, " &c4. &7{PTOP-DEATHS-4}")
                            .put(50, " &c5. &7{PTOP-DEATHS-5}")
                            .put(51, " &c6. &7{PTOP-DEATHS-6}")
                            .put(52, " &c7. &7{PTOP-DEATHS-7}")
                            .put(53, " &c8. &7{PTOP-DEATHS-8}")
                            .put(54, " &c9. &7{PTOP-DEATHS-9}")
                            .put(55, " &c10. &7{PTOP-DEATHS-10}")
