...
public class TablistConfiguration extends OkaeriConfig {
    ...
    @Comment(
        "{GTOP-<typ>-<pozycja>} - gildia na podanej pozycji w rankingu (np. {GTOP-KILLS-1}, {PTOP-DEATHS-50}), dla danego typu rankingu"
    )
    ...
    public String footer =
        "&c&lWiadomosci braku (pokazujace sie, gdy gracz nie ma gildii) mozna zmienic w pliku &6&lmessages.yml&c&l!";
    ...
    @Comment(
        "1 cykl to 1 wysłanie listy, częstotliwość wysyłania listy można ustawić zmieniając wartość 'update-interval'"
    )
    @Comment(" ")
    @Comment(
        "Podsekcję 'cells' konfiguruje się analogicznie jak główną sekcje 'cells' - ustawia się w niej wszystkie komórki, które mają się zmieniać (nadpisując zwykłą konfigurację)"
    )
