...
public class TablistConfiguration extends OkaeriConfig {
    ...
    @Comment("{G-VALIDITY-TIME} - czas do wygaśnięcia gildii (długa forma np. 5 dni, 2 godziny, 1 minuta)")
    @Comment("{G-VALIDITY-TIME-SHORT} - czas do wygaśnięcia gildii (krótka forma np. 5d 2h 1m)")
    @Comment("{G-PROTECTION} - data wygaśnięcia ochrony gildii")
    @Comment("{G-PROTECTION-TIME} - czas do wygaśnięcia ochrony gildii (długa forma np. 5 dni, 2 godziny, 1 minuta)")
    @Comment("{G-PROTECTION-TIME-SHORT} - czas do wygaśnięcia ochrony gildii (krótka forma np. 5d 2h 1m)")
