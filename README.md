...
#### Download
Get the latest stable version: [FunnyGuilds Tribute 4.9.0 (1.8.8+)](https://github.com/FunnyGuilds/FunnyGuilds/releases) <br>
Be among the first to explore future releases of FunnyGuilds: [FunnyGuilds 4.9.0+ Nightly](https://ci.insertt.dev/job/FunnyGuilds) <br>
