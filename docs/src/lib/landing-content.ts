...
export const LANDING_CONTENT: Record<'pl' | 'en', LandingContent> = {
  pl: {
    ...
    plHref: '/',
    enHref: '/en/',
    pageTitle: 'FunnyGuilds — tereny, wojny i rankingi gildii dla Paper/Spigot',
    pageDescription:
      'Rozbudowany, w pełni konfigurowalny plugin RPG do gildii dla serwerów Minecraft (Paper 1.8–1.21.x). Tereny, wojny, rankingi i społeczność w jednym pluginie.',
    eyebrow: 'Open-source · Paper / Spigot',
    headline: 'Wszystko, czego potrzebuje gildia.',
    sub: 'Tereny, wojny, rankingi i społeczność — w jednym pluginie, w pełni pod kontrolą administratora.',
    tags: ['Tereny', 'Wojny', 'Rankingi', 'Społeczność'],
