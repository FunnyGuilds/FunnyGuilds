package net.dzikoysk.funnyguilds.util.element.schematic;
...
public final class SchematicHelper {
    ...
    public static void pasteSchematic(File schematicFile, Location location, boolean withAir) throws MaxChangedBlocksException, IOException {
        ...
        if (!withAir) copy.setSourceMask(new ExistingBlockMask(clipboard));
