...
public class V1_14R1PlayerList implements PlayerList {
    ...
    static {
        try {
            ...
            throw new RuntimeException(String.format("Could not initialize '%s'", V1_14R1PlayerList.class.getName()), ex);
        }
    }
    ...
    public V1_14R1PlayerList(int cellCount) {
