package net.dzikoysk.funnyguilds.nms.v1_20R3.packet;
...
public class V1_20R3PacketAccessor implements PacketAccessor {
    
    private final GenericInboundChannelHandlerInstaller<V1_20R3FunnyGuildsInboundChannelHandler> inboundChannelHandlerInstaller =
            new GenericInboundChannelHandlerInstaller<>(V1_20R3FunnyGuildsInboundChannelHandler::new);
    private final GenericOutboundChannelHandlerInstaller<V1_20R3FunnyGuildsOutboundChannelHandler> outboundChannelHandlerInstaller =
            new GenericOutboundChannelHandlerInstaller<>(V1_20R3FunnyGuildsOutboundChannelHandler::new);
    ...
    private NetworkManager getNetworkManager(EntityPlayer entityPlayer) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to initialise V1_20R3PacketAccessor", exception);
        }
    }
