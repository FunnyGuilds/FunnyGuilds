...
public class V1_20R3FunnyGuildsInboundChannelHandler extends ChannelInboundHandlerAdapter implements FunnyGuildsInboundChannelHandler {
    ...
    static {
        try {
            ...
            throw new RuntimeException("Failed to initialise V1_20R2FunnyGuildsInboundChannelHandler", e);
        }
    }
