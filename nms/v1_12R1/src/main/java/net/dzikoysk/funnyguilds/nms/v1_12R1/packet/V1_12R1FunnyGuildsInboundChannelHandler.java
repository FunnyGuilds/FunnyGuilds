...
public class V1_12R1FunnyGuildsInboundChannelHandler extends ChannelInboundHandlerAdapter implements FunnyGuildsInboundChannelHandler {
    ...
    static {
        try {
            ...
            throw new RuntimeException("Failed to initialise V1_12R1FunnyGuildsChannelHandler", exception);
        }
    }
