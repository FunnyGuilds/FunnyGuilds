...
public class V1_15R1PlayerList implements PlayerList {
    ...
    static {
        try {
            ...
            throw new RuntimeException(String.format("Could not initialize '%s'", V1_15R1PlayerList.class.getName()), ex);
        }
    }
    ...
    public V1_15R1PlayerList(int cellCount) {
