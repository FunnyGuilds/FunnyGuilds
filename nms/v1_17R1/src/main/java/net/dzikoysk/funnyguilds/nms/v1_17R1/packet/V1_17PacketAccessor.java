...
public class V1_17PacketAccessor implements PacketAccessor {
    ...
    private final GenericInboundChannelHandlerInstaller channelHandlerInstaller = new GenericInboundChannelHandlerInstaller(V1_17R1FunnyGuildsChannelHandler::new);
