...
public class V1_11R1PacketAccessor implements PacketAccessor {
    ...
    private final GenericInboundChannelHandlerInstaller<V1_11R1FunnyGuildsInboundChannelHandler> inboundChannelHandlerInstaller =
            new GenericInboundChannelHandlerInstaller<>(V1_11R1FunnyGuildsInboundChannelHandler::new);
    private final GenericOutboundChannelHandlerInstaller<V1_11R1FunnyGuildsOutboundChannelHandler> outboundChannelHandlerInstaller =
            new GenericOutboundChannelHandlerInstaller<>(V1_11R1FunnyGuildsOutboundChannelHandler::new);
