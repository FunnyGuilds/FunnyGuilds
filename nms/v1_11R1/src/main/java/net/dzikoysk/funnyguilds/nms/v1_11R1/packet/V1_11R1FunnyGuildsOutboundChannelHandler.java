...
public class V1_11R1FunnyGuildsOutboundChannelHandler extends ChannelOutboundHandlerAdapter implements FunnyGuildsOutboundChannelHandler {
    ...
    static {
        try {
            ...
            throw new RuntimeException("Failed to initialise V1_11R1FunnyGuildsOutboundChannelHandler", exception);
        }
    }
