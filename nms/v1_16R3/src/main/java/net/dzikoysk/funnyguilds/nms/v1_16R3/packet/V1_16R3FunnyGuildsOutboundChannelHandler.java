...
public class V1_16R3FunnyGuildsOutboundChannelHandler extends ChannelOutboundHandlerAdapter implements FunnyGuildsOutboundChannelHandler {
    ...
    static {
        try {
            ...
            throw new RuntimeException("Failed to initialise V1_16R3FunnyGuildsOutboundChannelHandler", exception);
        }
    }
