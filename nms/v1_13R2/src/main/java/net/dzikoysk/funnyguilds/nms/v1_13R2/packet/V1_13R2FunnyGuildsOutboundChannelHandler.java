...
public class V1_13R2FunnyGuildsOutboundChannelHandler extends ChannelOutboundHandlerAdapter implements FunnyGuildsOutboundChannelHandler {
    ...
    static {
        try {
            ...
            throw new RuntimeException("Failed to initialise V1_13R2FunnyGuildsOutboundChannelHandler", exception);
        }
    }
