...
public class V1_9R2PlayerList implements PlayerList {
    ...
    static {
        try {
            ...
            throw new RuntimeException(String.format("Could not initialize '%s'", V1_9R2PlayerList.class.getName()), ex);
        }
    }
    ...
    public V1_9R2PlayerList(int cellCount) {
